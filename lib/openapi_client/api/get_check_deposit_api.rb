  ...
  class GetCheckDepositApi
    ...
    def execute_with_http_info(check_deposit_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GetCheckDepositApi.execute ...'
      end
      # verify the required parameter 'check_deposit_id' is set
      if @api_client.config.client_side_validation && check_deposit_id.nil?
        fail ArgumentError, "Missing the required parameter 'check_deposit_id' when calling GetCheckDepositApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"GetCheckDepositApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GetCheckDepositApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
