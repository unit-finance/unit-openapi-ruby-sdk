...
module OpenapiClient
  class GetListApplicationsApi
    ...
    # @option opts [ExecuteFilterParameter] :filter 
    ...
    def execute_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GetListApplicationsApi.execute ...'
      end
      # resource path
      ...
      header_params['Accept'] = @api_client.select_header_accept(['application/vnd.api+json', 'application/json'])
      ...
      new_options = opts.merge(
        :operation => :"GetListApplicationsApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GetListApplicationsApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
