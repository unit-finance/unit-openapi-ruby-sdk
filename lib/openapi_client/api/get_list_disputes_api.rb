...
module OpenapiClient
  class GetListDisputesApi
    ...
    # @option opts [ExecuteFilterParameter19] :filter 
    ...
    def execute_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GetListDisputesApi.execute ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"GetListDisputesApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GetListDisputesApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
