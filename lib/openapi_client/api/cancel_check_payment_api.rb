  ...
  class CancelCheckPaymentApi
    ...
    def execute_with_http_info(check_payment_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CancelCheckPaymentApi.execute ...'
      end
      # verify the required parameter 'check_payment_id' is set
      if @api_client.config.client_side_validation && check_payment_id.nil?
        fail ArgumentError, "Missing the required parameter 'check_payment_id' when calling CancelCheckPaymentApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CancelCheckPaymentApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CancelCheckPaymentApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
