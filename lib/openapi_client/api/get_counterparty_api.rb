  ...
  class GetCounterpartyApi
    ...
    def execute_with_http_info(counterparty_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GetCounterpartyApi.execute ...'
      end
      # verify the required parameter 'counterparty_id' is set
      if @api_client.config.client_side_validation && counterparty_id.nil?
        fail ArgumentError, "Missing the required parameter 'counterparty_id' when calling GetCounterpartyApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"GetCounterpartyApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GetCounterpartyApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
