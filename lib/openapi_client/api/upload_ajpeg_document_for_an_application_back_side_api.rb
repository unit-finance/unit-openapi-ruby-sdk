...
module OpenapiClient
  class UploadAJPEGDocumentForAnApplicationBackSideApi
    ...
    # @param body [Object] Upload JPEG File - Back Side
    ...
    def execute_with_http_info(application_id, document_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UploadAJPEGDocumentForAnApplicationBackSideApi.execute ...'
      end
      # verify the required parameter 'application_id' is set
      if @api_client.config.client_side_validation && application_id.nil?
        fail ArgumentError, "Missing the required parameter 'application_id' when calling UploadAJPEGDocumentForAnApplicationBackSideApi.execute"
      end
      # verify the required parameter 'document_id' is set
      if @api_client.config.client_side_validation && document_id.nil?
        fail ArgumentError, "Missing the required parameter 'document_id' when calling UploadAJPEGDocumentForAnApplicationBackSideApi.execute"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling UploadAJPEGDocumentForAnApplicationBackSideApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UploadAJPEGDocumentForAnApplicationBackSideApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UploadAJPEGDocumentForAnApplicationBackSideApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
