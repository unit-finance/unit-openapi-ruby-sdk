...
module OpenapiClient
  class GetListCounterpartiesApi
    ...
    def execute_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GetListCounterpartiesApi.execute ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"GetListCounterpartiesApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GetListCounterpartiesApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
