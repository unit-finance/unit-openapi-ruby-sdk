...
module OpenapiClient
  class GetReceivedPaymentsListApi
    ...
    def execute_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GetReceivedPaymentsListApi.execute ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"GetReceivedPaymentsListApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GetReceivedPaymentsListApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
