...
module OpenapiClient
  class GetCustomerApi
    ...
    def execute(customer_id, opts = {})
      data, _status_code, _headers = execute_with_http_info(customer_id, opts)
      data
    end
    ...
    def execute_with_http_info(customer_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GetCustomerApi.execute ...'
      end
      # verify the required parameter 'customer_id' is set
      if @api_client.config.client_side_validation && customer_id.nil?
        fail ArgumentError, "Missing the required parameter 'customer_id' when calling GetCustomerApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"GetCustomerApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GetCustomerApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
