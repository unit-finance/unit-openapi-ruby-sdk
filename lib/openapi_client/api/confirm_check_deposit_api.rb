  ...
  class ConfirmCheckDepositApi
    ...
    def execute_with_http_info(check_deposit_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConfirmCheckDepositApi.execute ...'
      end
      # verify the required parameter 'check_deposit_id' is set
      if @api_client.config.client_side_validation && check_deposit_id.nil?
        fail ArgumentError, "Missing the required parameter 'check_deposit_id' when calling ConfirmCheckDepositApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ConfirmCheckDepositApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConfirmCheckDepositApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
