...
module OpenapiClient
  class GetTaxFormApi
    ...
    # @param tax_form_id [String] The tax form id.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :included 
    # @return [UnitTaxFormResponse]
    def execute(tax_form_id, opts = {})
      data, _status_code, _headers = execute_with_http_info(tax_form_id, opts)
      data
    end
    ...
    def execute_with_http_info(tax_form_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GetTaxFormApi.execute ...'
      end
      # verify the required parameter 'tax_form_id' is set
      if @api_client.config.client_side_validation && tax_form_id.nil?
        fail ArgumentError, "Missing the required parameter 'tax_form_id' when calling GetTaxFormApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"GetTaxFormApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GetTaxFormApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
