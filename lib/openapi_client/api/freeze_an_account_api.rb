...
module OpenapiClient
  class FreezeAnAccountApi
    ...
    def execute(account_id, freeze_account_request, opts = {})
      data, _status_code, _headers = execute_with_http_info(account_id, freeze_account_request, opts)
      data
    end
    ...
    def execute_with_http_info(account_id, freeze_account_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FreezeAnAccountApi.execute ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling FreezeAnAccountApi.execute"
      end
      ...
      if @api_client.config.client_side_validation && freeze_account_request.nil?
        fail ArgumentError, "Missing the required parameter 'freeze_account_request' when calling FreezeAnAccountApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"FreezeAnAccountApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FreezeAnAccountApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
