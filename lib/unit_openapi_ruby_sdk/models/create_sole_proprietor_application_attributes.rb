  ...
  class CreateSoleProprietorApplicationAttributes
    ...
    def self.openapi_types
      {
        ...
        :'jwt_subject' => :'String',
        :'power_of_attorney_agent' => :'CreatePowerOfAttorneyAgent',
        :'industry' => :'Industry',
        :'evaluation_params' => :'EvaluationParams',
        :'occupation' => :'Occupation',
        :'annual_income' => :'AnnualIncome',
        :'source_of_income' => :'SourceOfIncome',
        :'annual_revenue' => :'SoleProprietorshipAnnualRevenue',
        :'number_of_employees' => :'SoleProprietorshipNumberOfEmployees',
        :'business_vertical' => :'BusinessVertical',
        :'website' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnitOpenapiRubySdk::CreateSoleProprietorApplicationAttributes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnitOpenapiRubySdk::CreateSoleProprietorApplicationAttributes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sole_proprietorship')
        ...
        self.sole_proprietorship = false
      end
    ...
    def valid?
      ...
      return false if !@ssn.nil? && @ssn !~ Regexp.new(/^\d{9}|\d{4}/)
    ...
    def hash
      [full_name, email, phone, ssn, passport, nationality, matricula_consular, address, date_of_birth, dba, ein, ip, sole_proprietorship, tags, idempotency_key, device_fingerprints, jwt_subject, power_of_attorney_agent, industry, evaluation_params, occupation, annual_income, source_of_income, annual_revenue, number_of_employees, business_vertical, website].hash
    end
