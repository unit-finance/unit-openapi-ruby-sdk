...
module UnitOpenapiRubySdk
  class BusinessApplicationAllOfAttributes
    ...
    attr_accessor :operating_address
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'operating_address')
        self.operating_address = attributes[:'operating_address']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          operating_address == o.operating_address
    end
