  ...
  class FullName
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnitOpenapiRubySdk::FullName` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnitOpenapiRubySdk::FullName`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @first.to_s.length > 255
        invalid_properties.push('invalid value for "first", the character length must be smaller than or equal to 255.')
      end
      ...
      if @last.to_s.length > 255
        invalid_properties.push('invalid value for "last", the character length must be smaller than or equal to 255.')
      end
    ...
    def valid?
      ...
      return false if @first.to_s.length > 255
      return false if @first.to_s.length < 1
      return false if @last.nil?
      return false if @last.to_s.length > 255
    ...
    def first=(first)
      ...
      if first.to_s.length > 255
        fail ArgumentError, 'invalid value for "first", the character length must be smaller than or equal to 255.'
      end
    ...
    def last=(last)
      ...
      if last.to_s.length > 255
        fail ArgumentError, 'invalid value for "last", the character length must be smaller than or equal to 255.'
      end
