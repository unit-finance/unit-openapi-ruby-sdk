...
module UnitOpenapiRubySdk
  class AchPaymentAllOfAttributes
    ...
    attr_accessor :counterparty_verification_method
    ...
    def self.attribute_map
      {
        ...
        :'same_day' => :'sameDay',
        :'counterparty_verification_method' => :'counterpartyVerificationMethod',
    ...
    def self.openapi_types
      {
        ...
        :'trace_number' => :'String',
        :'same_day' => :'Boolean',
        :'counterparty_verification_method' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnitOpenapiRubySdk::AchPaymentAllOfAttributes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnitOpenapiRubySdk::AchPaymentAllOfAttributes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'counterparty_verification_method')
        self.counterparty_verification_method = attributes[:'counterparty_verification_method']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          same_day == o.same_day &&
          counterparty_verification_method == o.counterparty_verification_method &&
    ...
    def hash
      [created_at, amount, direction, description, addenda, counterparty, tags, status, settlement_date, reason, expected_completion_date, sec_code, trace_number, same_day, counterparty_verification_method, clearing_days_override].hash
    end
