...
module UnitOpenapiRubySdk
  class CreateRecurringDebitAchPaymentAttributes
    ...
    attr_accessor :clearing_days_override
    ...
    def self.attribute_map
      {
        ...
        :'tags' => :'tags',
        :'schedule' => :'schedule',
        :'clearing_days_override' => :'clearingDaysOverride'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnitOpenapiRubySdk::CreateRecurringDebitAchPaymentAttributes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnitOpenapiRubySdk::CreateRecurringDebitAchPaymentAttributes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'clearing_days_override')
        self.clearing_days_override = attributes[:'clearing_days_override']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@clearing_days_override.nil? && @clearing_days_override < 0
        invalid_properties.push('invalid value for "clearing_days_override", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@clearing_days_override.nil? && @clearing_days_override < 0
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] clearing_days_override Value to be assigned
    def clearing_days_override=(clearing_days_override)
      if clearing_days_override.nil?
        fail ArgumentError, 'clearing_days_override cannot be nil'
      end

      if clearing_days_override < 0
        fail ArgumentError, 'invalid value for "clearing_days_override", must be greater than or equal to 0.'
      end

      @clearing_days_override = clearing_days_override
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tags == o.tags &&
          schedule == o.schedule &&
          clearing_days_override == o.clearing_days_override
    end
    ...
    def hash
      [amount, description, addenda, idempotency_key, same_day, verify_counterparty_balance, tags, schedule, clearing_days_override].hash
    end
