...
module UnitOpenapiRubySdk
  class BookTransactionRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnitOpenapiRubySdk::BookTransactionRelationships` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnitOpenapiRubySdk::BookTransactionRelationships`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'counterparty_customer')
        ...
        self.counterparty_customer = nil
      end
    ...
    def list_invalid_properties
      ...
      if @counterparty_customer.nil?
        invalid_properties.push('invalid value for "counterparty_customer", counterparty_customer cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @counterparty_customer.nil?
      true
    end
    ...
    def hash
      [account, customer, customers, counterparty_account, counterparty_customer, payment, recurring_payment].hash
    end
