...
module UnitOpenapiRubySdk
  class CreateCheckDepositRequestDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnitOpenapiRubySdk::CreateCheckDepositRequestDataAttributes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnitOpenapiRubySdk::CreateCheckDepositRequestDataAttributes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@clearing_days_override.nil? && @clearing_days_override < 1
        invalid_properties.push('invalid value for "clearing_days_override", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@clearing_days_override.nil? && @clearing_days_override < 1
    ...
    def clearing_days_override=(clearing_days_override)
      ...
      if clearing_days_override < 1
        fail ArgumentError, 'invalid value for "clearing_days_override", must be greater than or equal to 1.'
      end
    ...
    def hash
      [amount, clearing_days_override, description, idempotency_key, tags].hash
    end
