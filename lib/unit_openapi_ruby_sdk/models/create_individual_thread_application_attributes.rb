...
module UnitOpenapiRubySdk
  class CreateIndividualThreadApplicationAttributes
    attr_accessor :ssn
    ...
    def self.openapi_types
      {
        ...
        :'jwt_subject' => :'String',
        :'banks' => :'Array<String>',
        :'account_purpose' => :'ThreadIndividualAccountPurpose',
        :'account_purpose_detail' => :'String',
        :'source_of_funds' => :'ThreadIndividualSourceOfFunds',
        :'transaction_volume' => :'ThreadIndividualTransactionVolume',
        :'transaction_volume_description' => :'String',
        :'profession' => :'ThreadIndividualProfession'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnitOpenapiRubySdk::CreateIndividualThreadApplicationAttributes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnitOpenapiRubySdk::CreateIndividualThreadApplicationAttributes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @profession.nil?
        invalid_properties.push('invalid value for "profession", profession cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @profession.nil?
      true
    end
    ...
    def hash
      [ssn, passport, nationality, full_name, date_of_birth, address, phone, email, evaluation_params, ip, tags, idempotency_key, device_fingerprints, jwt_subject, banks, account_purpose, account_purpose_detail, source_of_funds, transaction_volume, transaction_volume_description, profession].hash
    end
