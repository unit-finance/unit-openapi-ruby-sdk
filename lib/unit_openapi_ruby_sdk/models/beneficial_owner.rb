...
module UnitOpenapiRubySdk
  class BeneficialOwner
    ...
    attr_accessor :evaluation_codes

    attr_accessor :occupation

    attr_accessor :annual_income

    attr_accessor :source_of_income
    ...
    def self.attribute_map
      {
        ...
        :'evaluation_codes' => :'evaluationCodes',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `UnitOpenapiRubySdk::BeneficialOwner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `UnitOpenapiRubySdk::BeneficialOwner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'evaluation_codes')
        if (value = attributes[:'evaluation_codes']).is_a?(Array)
          self.evaluation_codes = value
        end
      end
      ...
      if attributes.key?(:'source_of_income')
        self.source_of_income = attributes[:'source_of_income']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@percentage.nil? && @percentage < 25
        invalid_properties.push('invalid value for "percentage", must be greater than or equal to 25.')
      end
    ...
    def valid?
      ...
      return false if !@percentage.nil? && @percentage < 25
    ...
    def percentage=(percentage)
      ...
      if percentage < 25
        fail ArgumentError, 'invalid value for "percentage", must be greater than or equal to 25.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          evaluation_codes == o.evaluation_codes &&
          occupation == o.occupation &&
          annual_income == o.annual_income &&
          source_of_income == o.source_of_income
    end
    ...
    def hash
      [status, full_name, email, phone, ssn, passport, nationality, matricula_consular, address, date_of_birth, evaluation_id, percentage, evaluation_flags, masked_ssn, masked_passport, masked_matricula_consular, id_theft_score, evaluation_codes, occupation, annual_income, source_of_income].hash
    end
