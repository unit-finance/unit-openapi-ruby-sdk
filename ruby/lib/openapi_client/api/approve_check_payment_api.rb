...
module OpenapiClient
  class ApproveCheckPaymentApi
    ...
    def execute(check_payment_id, approve_check_payment_request, opts = {})
      data, _status_code, _headers = execute_with_http_info(check_payment_id, approve_check_payment_request, opts)
      data
    end
    ...
    def execute_with_http_info(check_payment_id, approve_check_payment_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ApproveCheckPaymentApi.execute ...'
      end
      # verify the required parameter 'check_payment_id' is set
      if @api_client.config.client_side_validation && check_payment_id.nil?
        fail ArgumentError, "Missing the required parameter 'check_payment_id' when calling ApproveCheckPaymentApi.execute"
      end
      ...
      if @api_client.config.client_side_validation && approve_check_payment_request.nil?
        fail ArgumentError, "Missing the required parameter 'approve_check_payment_request' when calling ApproveCheckPaymentApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ApproveCheckPaymentApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ApproveCheckPaymentApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
