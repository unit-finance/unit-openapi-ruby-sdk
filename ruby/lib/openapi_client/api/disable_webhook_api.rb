  ...
  class DisableWebhookApi
    ...
    def execute_with_http_info(webhook_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DisableWebhookApi.execute ...'
      end
      # verify the required parameter 'webhook_id' is set
      if @api_client.config.client_side_validation && webhook_id.nil?
        fail ArgumentError, "Missing the required parameter 'webhook_id' when calling DisableWebhookApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DisableWebhookApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DisableWebhookApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
