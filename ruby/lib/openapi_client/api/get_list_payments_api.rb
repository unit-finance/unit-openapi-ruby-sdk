  ...
  class GetListPaymentsApi
    ...
    def execute_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GetListPaymentsApi.execute ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"GetListPaymentsApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GetListPaymentsApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
