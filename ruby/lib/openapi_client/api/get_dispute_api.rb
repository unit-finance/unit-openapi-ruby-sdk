...
module OpenapiClient
  class GetDisputeApi
    ...
    def execute(dispute_id, opts = {})
      data, _status_code, _headers = execute_with_http_info(dispute_id, opts)
      data
    end
    ...
    def execute_with_http_info(dispute_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GetDisputeApi.execute ...'
      end
      # verify the required parameter 'dispute_id' is set
      if @api_client.config.client_side_validation && dispute_id.nil?
        fail ArgumentError, "Missing the required parameter 'dispute_id' when calling GetDisputeApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"GetDisputeApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GetDisputeApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
