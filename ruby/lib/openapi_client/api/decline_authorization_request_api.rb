...
module OpenapiClient
  class DeclineAuthorizationRequestApi
    ...
    def execute(authorization_id, decline_authorization_request, opts = {})
      data, _status_code, _headers = execute_with_http_info(authorization_id, decline_authorization_request, opts)
      data
    end
    ...
    def execute_with_http_info(authorization_id, decline_authorization_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DeclineAuthorizationRequestApi.execute ...'
      end
      # verify the required parameter 'authorization_id' is set
      if @api_client.config.client_side_validation && authorization_id.nil?
        fail ArgumentError, "Missing the required parameter 'authorization_id' when calling DeclineAuthorizationRequestApi.execute"
      end
      ...
      if @api_client.config.client_side_validation && decline_authorization_request.nil?
        fail ArgumentError, "Missing the required parameter 'decline_authorization_request' when calling DeclineAuthorizationRequestApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DeclineAuthorizationRequestApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DeclineAuthorizationRequestApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
