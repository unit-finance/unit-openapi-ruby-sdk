...
module OpenapiClient
  class CloseAnAccountApi
    ...
    def execute(account_id, close_account_request, opts = {})
      data, _status_code, _headers = execute_with_http_info(account_id, close_account_request, opts)
      data
    end
    ...
    def execute_with_http_info(account_id, close_account_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CloseAnAccountApi.execute ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling CloseAnAccountApi.execute"
      end
      ...
      if @api_client.config.client_side_validation && close_account_request.nil?
        fail ArgumentError, "Missing the required parameter 'close_account_request' when calling CloseAnAccountApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CloseAnAccountApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CloseAnAccountApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
