  ...
  class GetListRewardsApi
    ...
    def execute_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GetListRewardsApi.execute ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"GetListRewardsApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GetListRewardsApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
