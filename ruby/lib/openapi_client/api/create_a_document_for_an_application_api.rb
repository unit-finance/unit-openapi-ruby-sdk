...
module OpenapiClient
  class CreateADocumentForAnApplicationApi
    ...
    def execute_with_http_info(application_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CreateADocumentForAnApplicationApi.execute ...'
      end
      # verify the required parameter 'application_id' is set
      if @api_client.config.client_side_validation && application_id.nil?
        fail ArgumentError, "Missing the required parameter 'application_id' when calling CreateADocumentForAnApplicationApi.execute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CreateADocumentForAnApplicationApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CreateADocumentForAnApplicationApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
