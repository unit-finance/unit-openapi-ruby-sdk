...
module OpenapiClient
  class GetListCheckPaymentsApi
    ...
    # @option opts [ExecuteFilterParameter21] :filter 
    ...
    def execute_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GetListCheckPaymentsApi.execute ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"GetListCheckPaymentsApi.execute",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GetListCheckPaymentsApi#execute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
