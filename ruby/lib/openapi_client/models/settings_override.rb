  ...
  class SettingsOverride
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SettingsOverride` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SettingsOverride`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'validate_phone_number')
        self.validate_phone_number = attributes[:'validate_phone_number']
      else
        self.validate_phone_number = true
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          validate_phone_number == o.validate_phone_number
    end
    ...
    def hash
      [redirect_url, privacy_policy_url, electronic_disclosures_url, deposit_terms_url, client_terms_url, cardholder_terms_url, cash_advanced_terms_url, debit_card_disclosure_url, additional_disclosures, validate_phone_number].hash
    end
