...
# Unit tests for OpenapiClient::GenerateBarcodeApi
...
describe 'GenerateBarcodeApi' do
  ...
  describe 'test an instance of GenerateBarcodeApi' do
    it 'should create an instance of GenerateBarcodeApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::GenerateBarcodeApi)
    end
  end
  ...
  # @param execute_request Create Check Deposit Request
