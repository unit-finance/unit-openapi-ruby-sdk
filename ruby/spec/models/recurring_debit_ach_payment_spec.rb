...
describe OpenapiClient::RecurringDebitAchPayment do
  let(:instance) { OpenapiClient::RecurringDebitAchPayment.new }

  describe 'test an instance of RecurringDebitAchPayment' do
    it 'should create an instance of RecurringDebitAchPayment' do
      expect(instance).to be_instance_of(OpenapiClient::RecurringDebitAchPayment)
    end
  end
